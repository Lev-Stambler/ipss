...
func StartDHT(wg *sync.WaitGroup) {
	flag.Parse()
	infoHash := exampleIH
	...
	// TODO: these would be set up by the initial seeds
	dhtCfg.DHTRouters = "localhost:5234"
	dhtCfg.Address = "localhost"
	dhtCfg.Port = 5234

	d, err := dht.New(dhtCfg)
	if err != nil {
